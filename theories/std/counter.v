...
Section counter_GS.
  ...
  #[local] Definition counter_model1 γ_model n :=
    auth_excl_frag γ_model n.
  #[local] Definition counter_model2 γ_model dq n :=
  ...
  Proof.
    intros q1 q2. iSplit.
    - iIntros "(%l & %γ_mono & %γ_token & %γ_model & -> & #Hmeta_mono & #Hmeta_token & #Hmeta_model & (Hmono_auth1 & Hmono_auth2) & (Htoken_auth1 & Htoken_auth2) & (Hmodel2_1 & Hmodel2_2))".
      iSplitL "Hmono_auth1 Htoken_auth1 Hmodel2_1"; repeat iExists _; auto with iFrame.
    - iIntros "((%_l & %_γ_mono & %_γ_token & %_γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth1 & Htoken_auth1 & Hmodel2_1) & (%l & %γ_mono & %γ_token & %γ_model & % & #_Hmeta_mono & #_Hmeta_token & #_Hmeta_model & Hmono_auth2 & Htoken_auth2 & Hmodel2_2))". simplify.
      ...
      iCombine "Hmodel2_1 Hmodel2_2" as "Hmodel2".
  ...
  Lemma counter_lb_valid t dq n m :
    ...
    ⌜m ≤ n⌝.
  Proof.
    iIntros "(%_l & %_γ_mono & %γ_token & %γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2) (%l & %γ_mono & % & #_Hmeta_mono & Hmono_frag)". simplify.
    iDestruct (meta_agree with "Hmeta_mono _Hmeta_mono") as %->. iClear "_Hmeta_mono".
  ...
  Lemma counter_lb_get t dq n :
    ...
    counter_lb t n.
  Proof.
    iIntros "(%l & %γ_mono & %γ_token & %γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2)".
  ...
  Lemma counter_token_valid t dq n m :
    ...
    ⌜m < n⌝.
  Proof.
    iIntros "(%_l & %γ_mono & %_γ_token & %γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2) (%l & %γ_token & % & #_Hmeta_token & Htoken_frag)". simplify.
    iDestruct (meta_agree with "Hmeta_token _Hmeta_token") as %->. iClear "_Hmeta_token".
  ...
  Proof.
    iIntros "(%l & %γ_mono & %γ_token & %γ_model & -> & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2)".
    iApply (auth_excl_auth_valid with "Hmodel2").
  Qed.
  ...
  Proof.
    iIntros "(%_l & %_γ_mono & %_γ_token & %_γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth1 & Htoken_auth1 & Hmodel2_1) (%l & %γ_mono & %γ_token & %γ_model & % & #_Hmeta_mono & #_Hmeta_token & #_Hmeta_model & Hmono_auth2 & Htoken_auth2 & Hmodel2_2)". simplify.
    iDestruct (meta_agree with "Hmeta_model _Hmeta_model") as %->. iClear "_Hmeta_model".
    iApply (auth_excl_auth_valid_2 with "Hmodel2_1 Hmodel2_2").
  Qed.
  ...
  Proof.
    ...
    iMod (auth_excl_auth_persist with "Hmodel2") as "Hmodel2".
  ...
  Proof.
    iIntros "(%_l & %_γ_mono & %_γ_token & %_γ_model & % & #Hmeta_mono & #Hmeta_token & #Hmeta_model & Hmono_auth1 & Htoken_auth1 & Hmodel2_1) (%l & %γ_mono & %γ_token & %γ_model & % & #_Hmeta_mono & #_Hmeta_token & #_Hmeta_model & Hmono_auth2 & Htoken_auth2 & Hmodel2_2)". simplify.
    iDestruct (meta_agree with "Hmeta_model _Hmeta_model") as %->. iClear "_Hmeta_model".
    iApply (auth_excl_auth_exclusive with "Hmodel2_1 Hmodel2_2").
  Qed.
  ...
  Proof.
    ...
    iMod (auth_excl_alloc 0) as "(%γ_model & Hmodel2 & Hmodel1)"; first done.
  ...
  Proof.
    ...
    wp_rec.
    iInv "Hinv" as "(%n & Hl & Hmodel1)".
    wp_faa.
    iMod "HΦ" as "(%_n & (%_l & %γ_mono & %γ_token & %_γ_model & %Heq & #Hmeta_mono & #Hmeta_token & #_Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2) & _ & HΦ)". injection Heq as <-.
    iDestruct (meta_agree with "Hmeta_model _Hmeta_model") as %<-. iClear "_Hmeta_model".
    iDestruct (auth_excl_both_valid_L with "Hmodel2 Hmodel1") as %->.
    ...
    iMod (auth_excl_update' (S n) with "Hmodel2 Hmodel1") as "(Hmodel2 & Hmodel1)".
    iAssert (counter_token #l n) with "[Htoken_frag]" as "Htoken".
    { iExists l, γ_token. naive_solver. }
    iAssert (counter_model #l (DfracOwn 1) (S n)) with "[Hmono_auth Htoken_auth Hmodel2]" as "Hmodel".
    { iExists l, γ_mono, γ_token, γ_model. iFrame "∗#". done. }
  ...
  Proof.
    ...
    iInv "Hinv" as "(%n & Hl & Hmodel1)".
    wp_load.
    iMod "HΦ" as "(%dq & %_n & (%_l & %γ_mono & %γ_token & %_γ_model & %Heq & #Hmeta_mono & #Hmeta_token & #_Hmeta_model & Hmono_auth & Htoken_auth & Hmodel2) & _ & HΦ)". injection Heq as <-.
    iDestruct (meta_agree with "Hmeta_model _Hmeta_model") as %<-. iClear "_Hmeta_model".
    iDestruct (auth_excl_both_valid_L with "Hmodel2 Hmodel1") as %->.
    iAssert (counter_model #l dq n) with "[Hmono_auth Htoken_auth Hmodel2]" as "Hmodel".
    { iExists l, γ_mono, γ_token, γ_model. iFrame "∗#". done. }
