...
Proof.
  rewrite /auth_Z_min_auth /auth_Z_min_frag.
  rewrite -!assoc -auth_option_frag_op Z_min_op_eq.
  rewrite Z.min_id //.
Qed.
...
Lemma auth_Z_min_auth_dfrac_valid dq n :
  ...
  ✓ dq.
Proof.
  rewrite /auth_Z_min_auth auth_option_both_dfrac_valid_discrete /=. naive_solver.
Qed.
...
Lemma auth_Z_min_both_dfrac_valid dq n m :
  ...
  ✓ dq ∧ (n ≤ m)%Z.
Proof.
  rewrite /auth_Z_min_auth /auth_Z_min_frag -assoc -auth_option_frag_op.
  rewrite auth_option_both_dfrac_valid_discrete Z_min_included Z_min_op_eq /=.
  naive_solver lia.
Qed.
